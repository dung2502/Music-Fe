...
export const navigationHomeItems1 = [
    { id: 'library', label: 'Thư viện', link: '/favorites', icon: <Library />, iconPosition: 'left' },
...
export const navigationHomeItems3 = [
    ...
    { id: 'love-song', label: 'Bài hát yêu thích', link: 'favorites#song', icon: <LoveSong />, iconPosition: 'left' },
    { id: 'playlist', label: 'Playlist', link: 'favorites#playlist', icon: <Playlist />, iconPosition: 'left' },
    { id: 'album', label: 'Album', link: 'favorites#album', icon: <Album />, iconPosition: 'left' },
];
