...
import ModalMenuSigUp from '../ModalMenuSign/ModalMenuSign';
            ...
            <Modal isOpen={isOpen} onClose={onClose} displayCoat={false} idControl="avatar_active_modal_sigup">
                {!isAuthenticated ? (
                    ...
                    <Grid gd={{ maxWidth: "400px" }}>
                        ...
                        <Button text="Lịch sử thanh toán" gap={8} rounded="rounded-full" gd={{ minWidth: "240px" }} onClick={handlePaymentList} />
